...
export const settingsApi = {
  ...
  aiApis: {
    ...
    create: (body: { name: string; api_type: string; url?: string | null; model?: string; effort?: string | null; request_timeout?: number }) =>
      request<AiApiConfig>("/settings/ai-apis", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify(body),
      }),
    update: (id: number, body: { name?: string; url?: string | null; model?: string; effort?: string | null; request_timeout?: number }) =>
