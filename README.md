...
- Opt into `{keep}` (Settings → Library) to preserve the folder levels the template can't name — a faction, game system or release wave, however deep — instead of dropping them; it stops at the first level the destination already names
