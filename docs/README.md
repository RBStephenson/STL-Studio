...
| [Feature Guide](features.md) | Every screen and what it does — Library, Triage, favorites, print queue, image picker, Kit Builder, enrichment, backup & restore |
...
and assemble multi-part builds.
