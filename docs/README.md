...
| [Feature Guide](features.md) | Every screen and what it does — Library, Triage, favorites, print queue, collections, image picker, Kit Builder, enrichment, bulk enrich, import folder, install, reorganize, Paint Shelf & PaintRack CSV, AI & Integrations, backup & restore |
